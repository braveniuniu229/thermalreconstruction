...
import time
import os
from dataset.shallowdecoder.dataset_type_1000 import dataset_train,dataset_test
...
file = 'shallowdecoder_type_1000'
"""这里每次都要修改成训练的model"""
checkpoint_dir = "shallowdecoder_type_1000"   #这里修改成训练的断点
...
best_loss = float('inf')
num_epochs = 3000 # 假设训练 30 个 epochs
