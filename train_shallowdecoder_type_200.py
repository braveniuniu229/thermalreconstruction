...
import time
import os
from dataset.shallowdecoder.dataset_type_200 import dataset_train,dataset_test
...
file = 'shallowdecoder_type_200'
"""这里每次都要修改成训练的model"""
checkpoint_dir = "shallowdecoder_type_200"   #这里修改成训练的断点
