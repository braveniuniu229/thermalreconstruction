...
import time
import os
from dataset.shallowdecoder.dataset_type_200 import dataset_test
...
path = './data/Heat_Types200_source4_number500fixed_normalized.npz'
origin_data = np.load(path)
pod_data = origin_data['T'][:200,:400,:]
